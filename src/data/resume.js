...
반복되는 문제를 발견하면 자동화·표준화로 팀 전체가 쓰는 도구로 만듭니다. Claude 기반 산출물 자동화 스킬 3종을 직접 개발해 팀 표준으로 정착시켰고, 기능 구현에 그치지 않고 운영 단계까지 책임지고 참여합니다.`,
  ...
  skills: [
    ...
    },
    {
      ...
      level: "팀 표준 도구 직접 개발·배포",
      items: ["Claude Code 스킬 개발", "산출물 자동화 워크플로우", "AI 신제품 개발 참여"],
    },
    {
  ...
  experience: [
    {
      ...
      projects: [
        ...
        {
          name: "팀 AI 워크플로우 구축 — 산출물·온보딩·운영 자동화",
          period: "2025 ~ 현재 (제품 개발과 병행)",
          summary: "매뉴얼·PM 산출물·개발환경 세팅 등 담당자마다 품질 편차가 크던 반복 작업을 Claude 기반 스킬로 자동화.\n직접 설계·개발한 스킬 3종이 팀 공용 표준으로 채택되어 팀원 5명 이상이 실사용 중.",
          stack: ["Claude Code", "Node.js", "MongoDB"],
          items: [
            {
              title: "Claude 스킬 3종 설계·개발 및 팀 표준화",
              problem: "매뉴얼 한 건 작성에 평균 2시간, 산출물 품질은 담당자별 편차.\n신규 인력 온보딩 환경 세팅과 DB 백업도 수작업에 의존",
              solution: "회사 표준 양식 매뉴얼 자동 생성 · PM 산출물 자동화 · 개발환경 자동 세팅 — 스킬 3종을 직접 만들어 배포하고, 팀원 실사용 피드백으로 개선을 반복.\nDB 백업은 자동화 스크립트로 전환해 하루 3회 자동 실행",
              results: [
                "매뉴얼 작성 2시간 → 10분, 산출물 품질 표준화",
                "신규 인력 온보딩 2주 → 5일",
                "DB 백업 수작업 제거 — 백업 누락 리스크 차단",
              ],
            },
          ],
        },
